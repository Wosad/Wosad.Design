...
namespace Wosad.Reporting.ResultBuilder
{
    ...
    public static class DocumentBuilder
    {
        ...
        //KU
        public static void InitializeNewDocument(WordprocessingDocument output)
        {
        ...
        public static void AppendDocument(this WordprocessingDocument doc, WordprocessingDocument source, IEnumerable<XElement> contents,
