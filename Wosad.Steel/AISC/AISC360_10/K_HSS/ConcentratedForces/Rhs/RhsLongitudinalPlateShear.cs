...
namespace  Wosad.Analytics.Steel.AISC360_10.HSS.ConcentratedForces
{
    ...
    {
        ICalcLog CalcLog;
        public RhsLongitudinalPlateShear(SteelRhsSection Hss, SteelPlateSection Plate, SteelDesignFormat DesignFormat, ICalcLog CalcLog)
        ...
        public double GetAvailableStrength()
        {
            ...
            double t = Hss.Section.DesignWallThickness;
