...
using Wosad.Common.Maps;
using Wosad.Common.Mathematics;
using Wosad.Loads.ASCE7.Entities;
//using Wosad.Loads.ASCE7.ASCE7_10.C07_SnowLoads.MapData;

namespace Wosad.Loads.ASCE7.ASCE7_10.C07_SnowLoads
{
    public class GroundSnow: MapAnalyticalElement
    {
        ...
        {
            //this.MapId = Enum.Parse(typeof(Wosad.Loads.ASCE7.Entities.SnowMapId), SnowMapId);
