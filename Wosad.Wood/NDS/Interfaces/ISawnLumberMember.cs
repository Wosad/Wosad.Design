...
namespace Wosad.Wood.NDS
{
    ...
    {
        double GetAdjustedBendingDesignValue(double F_b, double C_M,double C_t, double C_L,double C_F, double C_fu,double C_i, double C_r, double lambda);
        ...
        double GetAdjustedShearTensionValue(double F_t, double C_M, double C_t, double C_F, double C_i, double lambda);
    }
}
